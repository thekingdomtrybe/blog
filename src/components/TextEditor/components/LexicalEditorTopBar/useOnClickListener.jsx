...
const useOnClickListener = () => {
  ...
  const formatCode = () => {
    if (blockType !== 'code') {
      ...
      // below code insert the new block but we only need to
      // format the specific part of the text into code format
      //   editor.update(() => {
      //     const selection = $getSelection();
  ...
  return {
    modal, onClick, selectedEventTypes, blockType, isLink, editor,
  };
};
