...
FloatingTextFormatToolbarPlugin.propTypes = {
  anchorElem: PropTypes.instanceOf(Element),
};

FloatingTextFormatToolbarPlugin.defaultProps = {
  anchorElem: document.body,
};
...
TextFormatFloatingToolbar.propTypes = {
  editor: PropTypes.shape({
    ...
    registerRootListener: PropTypes.func,
    registerCommand: PropTypes.func,
  }).isRequired,
  anchorElem: PropTypes.instanceOf(Element).isRequired,
